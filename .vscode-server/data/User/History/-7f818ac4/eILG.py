...
app = Flask(__name__)
from flaskr.models import User, UserConnect,Message,Post
from flaskr.forms import (
    LoginForm, RegisterForm, SettingForm, UserSearchForm, ConnectForm,MessageForm,PostForm
)
